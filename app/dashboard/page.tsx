    ...
    <main className="min-h-screen bg-[#f8faff]">
      ...
      <header className="border-b border-gray-100 bg-white px-6 py-4 sticky top-0 z-10">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/jobs" className="text-sm text-gray-500 hover:text-gray-700 transition-colors">
              Job Board
            </Link>
          ...
          <>
            ...
            <div className="mb-8">
              <div className="flex items-center justify-between mb-4">
                ...
                <Link href="/jobs" className="text-sm text-blue-600 hover:text-blue-700 transition-colors">
                  Browse Jobs
                </Link>
              </div>
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-6 text-white">
              ...
              <div className="mt-4 pt-4 border-t border-blue-500 flex items-center justify-between">
                ...
                <Link
                  href="https://www.base.dev/apps/69d26f3e24f9e4259fec4618"
                  target="_blank"
                  className="text-white text-xs font-medium hover:text-blue-200 transition-colors"
                >
                  View Dashboard
                </Link>
              </div>
